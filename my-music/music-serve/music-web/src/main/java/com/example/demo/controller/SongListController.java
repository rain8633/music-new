...
//    更新歌单图片
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "static/image" + System.getProperty("file.separator") + "songListPic" ;
        ...
        String storeAvatorPath = "/static/image/songListPic/" +fileName;
        try {
