...
public class GradeController {
    ...
    @Autowired
    private GradeServiceImpl rankService;
...
//    提交评分
    ...
    public Object addRank(HttpServletRequest req){
        ...
        grade.setSongListId(Long.parseLong(songListId));
        grade.setConsumerId(Long.parseLong(consumerId));
        grade.setScore(Integer.parseInt(score));

        boolean res = rankService.addRank(grade);
        if (res){
