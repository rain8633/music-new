...
//    更新歌手头像
    ...
    public Object updateSingerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "static/image" + System.getProperty("file.separator") + "singerPic" ;
        ...
        String storeAvatorPath = "/static/image/singerPic/" +fileName;
        try {
